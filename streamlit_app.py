...
<style>
:root {
    --app-bg:#f3f6fb; --surface:#ffffff; --surface-2:#f8fafc;
    --text-main:#0f172a; --text-muted:#64748b; --border:#e2e8f0;
}
[data-theme="dark"],[data-user-theme="dark"] {
    --app-bg:#0b1220; --surface:#1e293b; --surface-2:#0f172a;
    --text-main:#f8fafc; --text-muted:#cbd5e1; --border:#475569;
}
[data-theme="dark"] [data-testid="stMain"] p,
[data-theme="dark"] [data-testid="stMain"] li,
[data-user-theme="dark"] [data-testid="stMain"] p,
[data-user-theme="dark"] [data-testid="stMain"] li { color:var(--text-main)!important; }
[data-theme="dark"] label,[data-user-theme="dark"] label,
[data-theme="dark"] [data-testid="stWidgetLabel"] p,
[data-user-theme="dark"] [data-testid="stWidgetLabel"] p { color:#e2e8f0!important; }
[data-theme="dark"] [data-testid="stCaption"],
[data-user-theme="dark"] [data-testid="stCaption"] { color:var(--text-muted)!important; }
[data-theme="dark"] [data-testid="stChatMessage"] [data-testid="stMarkdownContainer"],
[data-user-theme="dark"] [data-testid="stChatMessage"] [data-testid="stMarkdownContainer"] { color:#e2e8f0!important; }
[data-theme="dark"] .stSelectbox [data-baseweb="select"] span,
[data-user-theme="dark"] .stSelectbox [data-baseweb="select"] span { color:var(--text-main)!important; }
[data-theme="dark"] [data-baseweb="popover"] li,
[data-user-theme="dark"] [data-baseweb="popover"] li { color:#0f172a!important; }
...
.block-container {
    padding-top:12px!important; padding-left:32px!important;
    padding-right:32px!important; max-width:100%!important;
}
.app-topbar {
...
.app-topbar-inner { display:flex; align-items:center; gap:8px; flex-wrap:wrap; font-family:'Plus Jakarta Sans',sans-serif; }
...
[data-testid="stSidebar"] .stRadio > div {
    ...
    gap:4px!important; width:100%!important; align-items:stretch!important;
}
...
[data-testid="collapsedControl"]:hover {
    ...
    box-shadow    : 0 6px 28px rgba(37,99,235,0.7),
                    0 0 0 1px rgba(191,219,254,0.35) inset !important;
...
[data-testid="stSidebar"] .st-keyboard-shortcut { display:none!important; }

/* ── METRIC CARDS ────────────────────────────────── */
[data-testid="stMetric"] {
    border-radius:14px!important; padding:22px 24px!important; min-height:115px!important;
...
[data-testid="stMetric"]:hover { transform:translateY(-3px)!important; box-shadow:0 8px 30px rgba(0,0,0,0.1)!important; }
[data-testid="stMetricLabel"] p { font-size:10.5px!important; font-weight:700!important; text-transform:uppercase!important; letter-spacing:0.08em!important; white-space:normal!important; word-break:break-word!important; line-height:1.4!important; }
[data-testid="stMetricValue"] { font-size:26px!important; font-weight:800!important; line-height:1.2!important; white-space:normal!important; word-break:break-word!important; font-family:'Plus Jakarta Sans',sans-serif!important; }
[data-testid="column"] { display:flex!important; flex-direction:column!important; }
[data-testid="column"] [data-testid="stMetric"] { flex:1!important; }
[data-theme="light"] [data-testid="stMetric"],[data-user-theme="light"] [data-testid="stMetric"] { background:#ffffff!important; border:1px solid #e2e8f0!important; }
[data-theme="light"] [data-testid="stMetricLabel"] p,[data-user-theme="light"] [data-testid="stMetricLabel"] p { color:#64748b!important; }
[data-theme="light"] [data-testid="stMetricValue"],[data-user-theme="light"] [data-testid="stMetricValue"] { color:#0f172a!important; }
[data-theme="dark"] [data-testid="stMetric"],[data-user-theme="dark"] [data-testid="stMetric"] { background:#1e293b!important; border:1px solid #334155!important; }
[data-theme="dark"] [data-testid="stMetricLabel"] p,[data-user-theme="dark"] [data-testid="stMetricLabel"] p { color:#94a3b8!important; }
[data-theme="dark"] [data-testid="stMetricValue"],[data-user-theme="dark"] [data-testid="stMetricValue"] { color:#f1f5f9!important; }
[data-testid="column"]:nth-child(1) [data-testid="stMetric"]::before { content:''; position:absolute; top:0;left:0;right:0; height:3px; background:linear-gradient(90deg,#2563eb,#3b82f6); border-radius:14px 14px 0 0; }
[data-testid="column"]:nth-child(2) [data-testid="stMetric"]::before { content:''; position:absolute; top:0;left:0;right:0; height:3px; background:linear-gradient(90deg,#0891b2,#22d3ee); border-radius:14px 14px 0 0; }
[data-testid="column"]:nth-child(3) [data-testid="stMetric"]::before { content:''; position:absolute; top:0;left:0;right:0; height:3px; background:linear-gradient(90deg,#7c3aed,#a78bfa); border-radius:14px 14px 0 0; }
[data-testid="column"]:nth-child(4) [data-testid="stMetric"]::before { content:''; position:absolute; top:0;left:0;right:0; height:3px; background:linear-gradient(90deg,#059669,#34d399); border-radius:14px 14px 0 0; }

/* ── BUTTONS ─────────────────────────────────────── */
.stButton > button { font-family:'Plus Jakarta Sans',sans-serif!important; font-weight:600!important; font-size:13px!important; border-radius:10px!important; border:none!important; transition:all 0.18s ease!important; letter-spacing:0.01em!important; }
.stButton > button[kind="primary"] { background:linear-gradient(135deg,#2563eb,#1d4ed8)!important; color:#ffffff!important; box-shadow:0 2px 8px rgba(37,99,235,0.3)!important; padding:12px 28px!important; }
.stButton > button[kind="primary"]:hover { background:linear-gradient(135deg,#1d4ed8,#1e40af)!important; transform:translateY(-1px)!important; box-shadow:0 6px 20px rgba(37,99,235,0.4)!important; }
.stButton > button[kind="secondary"] { background:transparent!important; color:#2563eb!important; border:1.5px solid #2563eb!important; }
.stButton > button[kind="secondary"]:hover { background:#eff6ff!important; }
[data-theme="dark"] .stButton > button[kind="secondary"],[data-user-theme="dark"] .stButton > button[kind="secondary"] { color:#e2e8f0!important; border-color:#475569!important; background:rgba(30,41,59,0.5)!important; }
[data-theme="dark"] .stButton > button[kind="secondary"]:hover,[data-user-theme="dark"] .stButton > button[kind="secondary"]:hover { background:rgba(51,65,85,0.65)!important; }
[data-testid="stSidebar"] .stButton > button[kind="secondary"] { color:#cbd5e1!important; border-color:#475569!important; }
[data-testid="stSidebar"] .stButton > button[kind="secondary"]:hover { background:rgba(255,255,255,0.06)!important; }

/* ── INPUTS ──────────────────────────────────────── */
.stTextInput input,.stTextArea textarea {
    font-family:'Plus Jakarta Sans',sans-serif!important; border:1.5px solid var(--border)!important;
    border-radius:10px!important; font-size:13.5px!important; transition:all 0.18s ease!important;
    color:var(--text-main)!important; background:var(--surface)!important;
}
.stTextInput input:focus,.stTextArea textarea:focus { border-color:#2563eb!important; box-shadow:0 0 0 3px rgba(37,99,235,0.12)!important; }

/* ── FIX 1: FILE UPLOADER dark theme ────────────── */
[data-testid="stFileUploader"] {
    border:2px dashed var(--border)!important; border-radius:12px!important;
    background:var(--surface-2)!important; transition:all 0.18s ease!important;
}
[data-testid="stFileUploader"]:hover { border-color:#2563eb!important; }
[data-theme="light"] [data-testid="stFileUploader"]:hover,
[data-user-theme="light"] [data-testid="stFileUploader"]:hover { background:#eff6ff!important; border-color:#2563eb!important; }
/* Dark — proper dark bg, no white flashes */
[data-theme="dark"] [data-testid="stFileUploader"],
[data-user-theme="dark"] [data-testid="stFileUploader"] {
    background:#162032!important; border-color:#334155!important; border-style:dashed!important;
}
[data-theme="dark"] [data-testid="stFileUploader"]:hover,
[data-user-theme="dark"] [data-testid="stFileUploader"]:hover {
    background:rgba(37,99,235,0.12)!important; border-color:#3b82f6!important;
}
[data-theme="dark"] [data-testid="stFileUploader"] p,
[data-theme="dark"] [data-testid="stFileUploader"] span,
[data-user-theme="dark"] [data-testid="stFileUploader"] p,
[data-user-theme="dark"] [data-testid="stFileUploader"] span { color:#94a3b8!important; }
[data-theme="dark"] [data-testid="stFileUploader"] small,
[data-user-theme="dark"] [data-testid="stFileUploader"] small { color:#64748b!important; }

/* ── EXPANDER ────────────────────────────────────── */
[data-testid="stExpander"] {
    border:1.5px solid var(--border)!important; border-radius:14px!important;
    background:var(--surface)!important; box-shadow:0 1px 4px rgba(0,0,0,0.05)!important;
    margin-bottom:14px!important; overflow:hidden!important; transition:all 0.18s ease!important;
}
[data-testid="stExpander"]:hover { box-shadow:0 6px 24px rgba(0,0,0,0.08)!important; transform:translateY(-1px)!important; }
[data-theme="dark"] [data-testid="stExpander"],[data-user-theme="dark"] [data-testid="stExpander"] { background:#1e293b!important; border-color:#334155!important; }

/* ── FIX 2 + 5: Chat messages — centered, constrained ── */
...
/* ── FIX 2: Chat input — compact, not giant ─────── */
...
[data-testid="stChatInput"] textarea::placeholder { color:var(--text-muted)!important; opacity:0.9!important; }
[data-testid="stChatInput"] button { border-radius:10px!important; }

/* ── FIX 3: RAG footer — below input, centered ──── */
.qa-rag-footer {
    text-align  : center;
...
[data-user-theme="dark"] .qa-rag-footer { color:#64748b!important; }
...
.doc-row { display:flex; align-items:center; gap:12px; padding:11px 16px; border-radius:10px; margin-bottom:6px; border:1px solid #e2e8f0; background:#ffffff; transition:all 0.18s ease; font-size:13.5px; font-weight:500; color:#334155; }
.doc-row:hover { border-color:#2563eb; box-shadow:0 0 0 3px rgba(37,99,235,0.08); }
[data-theme="dark"] .doc-row,[data-user-theme="dark"] .doc-row { background:#1e293b; border-color:#334155; color:#cbd5e1; }
...
[data-theme="dark"] .doc-badge,[data-user-theme="dark"] .doc-badge { background:#1e3a5f; color:#60a5fa; }
...
[data-theme="dark"] .info-val,[data-user-theme="dark"] .info-val { background:#334155; color:#f1f5f9; }
[data-theme="dark"] .info-row,[data-user-theme="dark"] .info-row { border-color:#1e293b; color:#94a3b8; }
...
[data-theme="dark"] .card,[data-user-theme="dark"] .card { background:#1e293b; border-color:#334155; }
.card-head { padding:16px 22px; border-bottom:1px solid #e2e8f0; display:flex; align-items:center; justify-content:space-between; }
[data-theme="dark"] .card-head,[data-user-theme="dark"] .card-head { border-color:#334155; }
.card-title { font-size:14px; font-weight:700; color:#0f172a; }
[data-theme="dark"] .card-title,[data-user-theme="dark"] .card-title { color:#f1f5f9; }
...
[data-theme="dark"] .step-title,[data-user-theme="dark"] .step-title { color:#f1f5f9; }
.step-desc { font-size:12.5px; color:#64748b; line-height:1.5; }
[data-theme="dark"] .step-desc,[data-user-theme="dark"] .step-desc { color:var(--text-muted); }
.section-title { font-size:22px; font-weight:800; color:#0f172a; margin:0 0 4px 0; font-family:'Plus Jakarta Sans',sans-serif; }
[data-theme="dark"] .section-title,[data-user-theme="dark"] .section-title { color:#f1f5f9; }
...
[data-theme="dark"] .upload-preview,[data-user-theme="dark"] .upload-preview { background:rgba(37,99,235,0.14); border-color:rgba(96,165,250,0.35); }
.upload-preview-name { flex:1; font-weight:600; color:#2563eb; }
[data-theme="dark"] .upload-preview-name,[data-user-theme="dark"] .upload-preview-name { color:#93c5fd; }
...
[data-theme="dark"] .callout-info,[data-user-theme="dark"] .callout-info { background:rgba(30,58,138,0.25); border-color:rgba(96,165,250,0.28); }
...
[data-theme="dark"] .body-text a,[data-user-theme="dark"] .body-text a { color:#60a5fa; }
...
def login_page():
    ...
    <div style="max-width:440px;margin:60px auto 0;">
        <div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);
            ...
            <div style="font-size:28px;font-weight:800;color:#ffffff;position:relative;z-index:1;
                font-family:'Plus Jakarta Sans',sans-serif;">AssistHR</div>
    ...
    with col:
        ...
        with tab2:
            ...
            if st.button("Create Account →", use_container_width=True, type="primary", key="reg_btn"):
                if not all([name,email,password,confirm]): st.error("Please fill in all fields.")
...
<div style="padding:20px 16px 16px;">
    <div style="display:flex;align-items:center;gap:10px;margin-bottom:10px;">
        ...
        <div>
            <div style="color:#ffffff;font-size:17px;font-weight:800;line-height:1;
                font-family:'Plus Jakarta Sans',sans-serif;">AssistHR</div>
            <div style="color:#475569;font-size:9.5px;letter-spacing:1.2px;
...
<div style="padding:2px 16px 6px;">
    <div style="color:#475569;font-size:9px;letter-spacing:1.5px;
        text-transform:uppercase;font-weight:700;margin-bottom:4px;">Main Menu</div>
</div>
""", unsafe_allow_html=True)
...
(function(){{
  ...
  else if(choice==="System") mode=window.matchMedia("(prefers-color-scheme:dark)").matches?"dark":"light";
  root.setAttribute("data-user-theme",mode); root.setAttribute("data-theme",mode);
  ...
  function stripHints(){{
    ...
    if(cc){{cc.removeAttribute("title");cc.removeAttribute("aria-label");
      const btn=(cc.tagName==="BUTTON")?cc:cc.closest("button");
      if(btn){{btn.removeAttribute("title");btn.removeAttribute("aria-label");}}
    }}
    doc.querySelectorAll('[data-testid="stSidebar"] button[title],[data-testid="stSidebar"] [title]')
      .forEach(function(el){{
        const t=(el.getAttribute("title")||"")+(el.getAttribute("aria-label")||"");
        if(/keyboard|shortcut|Press|⌘|Ctrl|\\[/i.test(t)){{el.removeAttribute("title");el.removeAttribute("aria-label");}}
      }});
  }}
  stripHints();
...
# Chat sessions panel (Q&A only)
if page == "💬  HR Q&A":
    st.sidebar.markdown("""
    <div style="padding:0 16px 6px;">
        <div style="color:#64748b;font-size:9px;letter-spacing:1.4px;
            text-transform:uppercase;font-weight:700;">Chat Sessions</div>
    </div>
    """, unsafe_allow_html=True)
    ...
    try:
        ...
        _cur.execute(
            "SELECT session_id FROM sessions WHERE session_id LIKE %s "
        ...
        for row in _rows:
            ...
            if st.sidebar.button(f"{icon}  {disp}", key=f"cs_{raw}",
...
if page == "📊  Dashboard":
    ...
    <div style="background:linear-gradient(135deg,#0f172a 0%,#1e3a5f 100%);
        ...
        <div style="position:relative;z-index:1;">
            <h2 style="color:#ffffff;margin:0;font-size:24px;font-weight:800;
            ...
            <p style="color:#94a3b8;margin:8px 0 16px;font-size:13.5px;line-height:1.6;max-width:520px;">
                ...
                Upload HR policies, ask questions, screen resumes — all in one place.</p>
    ...
    try:
        ...
        _cd = _gc_dash(); _cur_d = _cd.cursor()
        _cur_d.execute("SELECT COUNT(*) FROM sessions WHERE session_id LIKE %s",(f"{current_email}_%",))
        sessions_count = _cur_d.fetchone()[0]
        _cur_d.execute("SELECT session_id FROM sessions WHERE session_id LIKE %s ORDER BY last_active DESC LIMIT 6",(f"{current_email}_%",))
        dash_session_rows = _cur_d.fetchall(); _cd.close()
    except Exception:
        sessions_count = 0; dash_session_rows = []
    ...
    with col_left:
        ...
        <div class="card-body">
            <div class="step-item"><div class="step-num" style="background:#2563eb;">1</div><div>
                <div class="step-title">Upload HR Documents</div>
                <div class="step-desc">Go to <b>Knowledge Base</b> → Upload HR policy files (PDF, DOCX, TXT). They get indexed automatically.</div>
            </div></div>
            <div class="step-item"><div class="step-num" style="background:#0891b2;">2</div><div>
                <div class="step-title">Ask Questions (RAG)</div>
                <div class="step-desc">Go to <b>HR Q&A</b> → Type any question. AssistHR searches your documents and answers using Groq LLM.</div>
            </div></div>
            <div class="step-item" style="margin-bottom:0"><div class="step-num" style="background:#d97706;">3</div><div>
                <div class="step-title">Screen Resumes</div>
                <div class="step-desc">Go to <b>Resume Screener</b> → Upload JD + resumes → get ranked candidates with scores and skill analysis.</div>
            </div></div>
        </div></div>
        """, unsafe_allow_html=True)
    ...
    with col_right:
        ...
        for label, value in [("🤖 LLM","Groq llama-3.3-70b"),("⚡ Vector DB","Supabase pgvector"),("📐 Embeddings","MiniLM-L12-v2"),("🔍 Search","Cosine Similarity"),("🗄️ Database","Supabase PostgreSQL"),("🔐 Auth","Supabase Auth")]:
    ...
    with dc:
        ...
        if not all_docs: st.info("No documents yet. Upload from Knowledge Base.")
        else:
            icons = {"pdf":"📕","docx":"📘","txt":"📄"}
            for doc in list(all_docs)[:6]:
                ext = doc.split(".")[-1].lower() if "." in doc else "file"
                st.markdown(f'<div class="doc-row"><span style="font-size:18px;">{icons.get(ext,"📄")}</span><span style="flex:1;font-size:13px;font-weight:600;">{doc}</span><span class="doc-badge">{ext}</span></div>', unsafe_allow_html=True)
        st.markdown("</div></div>", unsafe_allow_html=True)
    ...
    with sc:
        ...
        if not dash_session_rows: st.info("No sessions yet. Open **HR Q&A** to start chatting.")
        else:
...
# ══════════════════════════════════════════════════════════════
    ...
    try:
        ...
        if not existing: st.info("No documents yet. Upload above.")
        else:
            icons = {"pdf":"📕","docx":"📘","txt":"📄"}
            for doc in existing:
                ext = doc.split(".")[-1].lower() if "." in doc else "file"
                st.markdown(f'<div class="doc-row"><span style="font-size:18px;">{icons.get(ext,"📄")}</span><span style="flex:1;font-size:13px;font-weight:600;">{doc}</span><span class="doc-badge">{ext}</span></div>', unsafe_allow_html=True)
    except Exception as e: st.error(f"Could not load: {e}")
    st.markdown("</div></div>", unsafe_allow_html=True)


# ══════════════════════════════════════════════════════════════
# HR Q&A  — all 3 fixes applied here
# ══════════════════════════════════════════════════════════════
    ...
    # FIX 5: session + model controls in a centered column
    _, ctrl_col, _ = st.columns([0.5, 3, 0.5])
    with ctrl_col:
    ...
    if not st.session_state.messages:
        ...
        _, sug_col, _ = st.columns([0.5, 3, 0.5])
        with sug_col:
            scols = st.columns(4)
            for col, sug in zip(scols, [
    ...
    # FIX 5: messages in a centered column
    _, msg_col, _ = st.columns([0.5, 3, 0.5])
    with msg_col:
    ...
    # FIX 2 + 3: compact chat input then RAG footer directly below it
    ...
    with chat_col:
        ...
        # FIX 3: RAG note below the input box
        st.markdown(
...
# ══════════════════════════════════════════════════════════════
    ...
    if screen_clicked:
        if not jd: st.error("Please upload a Job Description.")
        elif not resumes: st.error("Please upload at least one resume.")
        else:
            jd_path = f"/tmp/{jd.name}"
            with open(jd_path,"wb") as f: f.write(jd.getbuffer())
            resume_paths = []
            for r in resumes:
                p = f"/tmp/{r.name}"
            ...
            with st.spinner("Screening candidates..."):
                try: results = screen_all(resume_paths, jd_path, model)
                except Exception as e: st.error(f"❌ {e}"); results = []
            ...
            if results:
                ...
                for i, r in enumerate(results, 1):
                    ...
                    with st.expander(f"{medals.get(i,f'#{i}')}  {name}  |  {score}%  |  {verdict}", expanded=(i==1)):
                        st.markdown(f"""
                        ...
                        with c2:
                            ...
                            extra = ('🔗 <a href="'+ln+'" target="_blank">LinkedIn</a><br/>' if ln else '') + ('💻 <a href="'+gh+'" target="_blank">GitHub</a>' if gh else '')
                            st.markdown(f'<div class="body-text">💼 {r.get("experience","N/A")}<br/>{extra}</div>', unsafe_allow_html=True)
                        ...
                        <div style="font-size:10.5px;color:var(--text-muted);margin-top:8px;text-align:right;">
